...
describe('Blockchain', ()=>{
    let blockchain, newChain, originalChain, postiveBlockChain, errorMock;
    ...
    describe ('isValidChain',()=> 
    {
        ...
        describe('validTransactionData()',()=>{
            ...
            describe('and transactional data atleast one malformed outMap',()=>{
                describe('and transaction is not a reward transacction ',()=>{
                    it('returns false',()=>{
